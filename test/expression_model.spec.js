  ...
  describe('ExpressionModel', function () {
    ...
    describe('evaluateNode', function () {
      ...
      describe('addition/subtraction: 1 + 2 - 3 - 4', function () {
        ...
        it('should not evaluate subtraction when respecting order-of-operations', function () {
      ...
      describe('addition with multiplication: 1 + 2 + 3 * 4', function () {
        ...
        it('should not evaluate the second addition because the multiplication takes precedence', function () {
